...
function showDetail(name) {
  const details = {
    ...
    baoyun: { name: '宝云', desc: '宝云主打海外中转线路，采用 VLESS 协议，节点覆盖香港、日本、台湾、新加坡、美国。支持常规流媒体解锁以及 ChatGPT、Gemini 等 AI 服务，套餐从 ¥4/月起。\n\n✅ 优点：入门价格低、节点覆盖亚洲与美国、VLESS 协议、AI 与 YouTube 4K 使用场景明确\n⚠️ 注意：速度与可用率为参考值，建议先月付验证本地晚高峰体验' },
    ...
    speedworld: { name: '速界机场', desc: '速界是一家专注企业级 IEPL 专线的高端机场，采用端到端独享 IEPL 国际专线链路，全程物理隔离无拥塞。实测速度 700Mbps-1.5Gbps，晚高峰依然稳定跑满带宽。支持 4K/8K 流媒体秒开、Netflix、ChatGPT、Zoom 视频会议不卡顿，适合远程办公、流媒体深度用户和游戏玩家。\n\n✅ 优点：真 IEPL 专线物理隔离、速度 700Mbps-1.5Gbps、延迟极低（0-30ms）、晚高峰稳定跑满、开业 8 折优惠年付低至 ¥6/月\n⚠️ 缺点：套餐价格相比普通中转机场略高（专线成本特性）、建议先用首月试用套餐体验' },
